...
#include "FGTurretSingle.generated.h"

UCLASS()
class FGFPS_API AFGTurretSingle : public AActor, public IFGWeaponInterface
{
	GENERATED_BODY()
public:
	AFGTurretSingle(const FObjectInitializer& ObjectInitializer);
